...
import inputFieldsReadme from '../src/styles/input-fields-README.md';
import checkboxesReadme from '../src/styles/checkboxes-README.md';
import radioButtonsReadme from '../src/styles/radio-buttons-README.md';
          ...
          <ul class="rux-form">
           <li class="rux-form-field">
            ...
            <li class="rux-form-field">
              ...
              <input id="input__number" class="rux-input" type="number" min="0" max="10" placeholder="Enter a Number between 0 and 10">
            </li>
            <li class="rux-form-field">
